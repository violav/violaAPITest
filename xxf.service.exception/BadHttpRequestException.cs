        ...
        internal static BadHttpRequestException GetException(RequestRejectionReason reason)
        {
            ...
            switch (reason)
            {
                case RequestRejectionReason.InvalidRequestHeadersNoCRLF:
                    ex = new BadHttpRequestException(Messages.BadRequest_InvalidRequestHeadersNoCRLF, StatusCodes.Status400BadRequest, reason);
                    break;
                ...
                //    break;
                default:
                    ex = new BadHttpRequestException(Messages.BadRequest, StatusCodes.Status400BadRequest, reason);
                    break;
            }
            return ex;
        }
